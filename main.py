...
"""
В face_classifier и classifier необходимо вставить путь до скаченного на Ваше устройство
детектора лиц OpenCV (haarcascade_frontalface_default.xml) и ускоренной с помощью TensorRT
модели (либо путь до скаченного по ссылке из репозитория и распакованного архива saved_model_trt)
"""

face_classifier = cv2.CascadeClassifier(r'C:\Users\rtm51\Downloads\Emotion_Detection\haarcascade_frontalface_default.xml') # классический (не нейросетевой) детектор лица OpenCV
classifier = load_model(r'C:\Users\rtm51\Downloads\saved_model_trt-20210716T124048Z-001\saved_model_trt') # обученная модель для классификации эмоций
